...
urlpatterns = [
    ...
    path("lesson/<int:lesson_id>/answer/", views.lesson_save_answer, name="lesson_save_answer"),
    ...
    path("lesson/<int:lesson_id>/check/<str:check_id>/", views.lesson_toggle_check, name="lesson_toggle_check"),
